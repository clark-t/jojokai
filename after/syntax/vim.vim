...
syntax match vimVarDeclear contained /\([sglbwt]:\)\{0,1}\w\+/ nextgroup=vimOperAssign
syntax keyword vimLet let unl[et] skipwhite nextgroup=vimVarDeclear,vimVar,vimFuncVar,vimLetHereDoc
syntax match vimVarPrefix contained /&\{0,1}\zs[sglbwt]:\ze[a-zA-Z0-9_]\+/ containedin=vimVar,vimVarDeclear,vimFBVar
syntax match vimVarRefer contained /&/ containedin=vimVar,vimVarDeclear,vimFBVar
