...
hi Title guifg=#D7D75F ctermfg=185 guibg=NONE ctermbg=NONE gui=bold cterm=bold
...
hi Todo guifg=#FF8700 ctermfg=208 guibg=NONE ctermbg=NONE gui=bold,italic cterm=bold,italic
hi Comment guifg=#767676 ctermfg=243 guibg=NONE ctermbg=NONE gui=italic cterm=italic
...
hi jsClassKeyword guifg=#5FD7FF ctermfg=81 guibg=NONE ctermbg=NONE gui=italic cterm=italic
...
hi typescriptGlobal guifg=#AF87FF ctermfg=141 guibg=NONE ctermbg=NONE gui=italic cterm=italic
...
hi typescriptIdentifier guifg=#AF87FF ctermfg=141 guibg=NONE ctermbg=NONE gui=italic cterm=italic
...
hi typescriptClassKeyword guifg=#5FD7FF ctermfg=81 guibg=NONE ctermbg=NONE gui=italic cterm=italic
...
hi typescriptRegexpString guifg=#AF87FF ctermfg=141 guibg=NONE ctermbg=NONE gui=italic cterm=italic
hi typescriptRegexpGroup guifg=#AF87FF ctermfg=141 guibg=NONE ctermbg=NONE gui=italic cterm=italic
hi typescriptRegexpOr guifg=#FF0087 ctermfg=198 guibg=NONE ctermbg=NONE gui=italic cterm=italic
hi typescriptRegexpBoundary guifg=#FF0087 ctermfg=198 guibg=NONE ctermbg=NONE gui=italic cterm=italic
hi typescriptRegexpQuantifier guifg=#FF0087 ctermfg=198 guibg=NONE ctermbg=NONE gui=italic cterm=italic
hi typescriptRegexpMod guifg=#FF0087 ctermfg=198 guibg=NONE ctermbg=NONE gui=italic cterm=italic
hi typescriptRegexpCharClass guifg=#D7D75F ctermfg=185 guibg=NONE ctermbg=NONE gui=italic cterm=italic
hi typescriptTypeReference guifg=#AF87FF ctermfg=141 guibg=NONE ctermbg=NONE gui=italic cterm=italic
hi typescriptTypeParameter guifg=#AF87FF ctermfg=141 guibg=NONE ctermbg=NONE gui=italic cterm=italic
...
hi cssURL guifg=#FF8700 ctermfg=208 guibg=NONE ctermbg=NONE gui=underline,italic cterm=underline,italic
...
hi markdownOrderedListMarker guifg=#AF87FF ctermfg=141 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi markdownCodeDelimiter guifg=#5FD7FF ctermfg=81 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi markdownUrl guifg=#767676 ctermfg=243 guibg=NONE ctermbg=NONE gui=underline cterm=underline
hi markdownBlockquote guifg=#AF87FF ctermfg=141 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi markdownError guifg=NONE ctermfg=NONE guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi markdownBold guifg=#FF0087 ctermfg=198 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi markdownStrike guifg=#767676 ctermfg=243 guibg=NONE ctermbg=NONE gui=strikethrough cterm=strikethrough
hi markdownItalic guifg=#AFD700 ctermfg=148 guibg=NONE ctermbg=NONE gui=italic cterm=italic
hi @markup.strong guifg=#FF0087 ctermfg=198 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi @markup.strikethrough guifg=#767676 ctermfg=243 guibg=NONE ctermbg=NONE gui=strikethrough cterm=strikethrough
hi @markup.italic guifg=#AFD700 ctermfg=148 guibg=NONE ctermbg=NONE gui=italic cterm=italic
hi @markup.raw.markdown_inline guifg=#5FD7FF ctermfg=81 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi @markup.raw.block.markdown guifg=#5FD7FF ctermfg=81 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi @markup.link.label.markdown_inline guifg=#AFD700 ctermfg=148 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi @markup.link.markdown_inline guifg=#DADADA ctermfg=253 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi @markup.link.url.markdown_inline guifg=#767676 ctermfg=243 guibg=NONE ctermbg=NONE gui=underline cterm=underline
hi @markup.quote.markdown guifg=#AF87FF ctermfg=141 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi @markup.list.markdown guifg=#AF87FF ctermfg=141 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi @punctuation.special.markdown guifg=#AF87FF ctermfg=141 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
